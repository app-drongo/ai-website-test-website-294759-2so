...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Empowering businesses with cutting-edge digital solutions and innovative web technologies. Trusted by over 10,000 companies worldwide to deliver exceptional user experiences.',
  ...
  newsletterDisclaimer:
    'Join our newsletter for industry insights and product updates. Unsubscribe anytime.',
  section1Title: 'Solutions',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 Test Website. All rights reserved.',
  madeWithText: 'by our dedicated team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/testwebsite',
  social2Href: 'https://facebook.com/testwebsite',
  social3Href: 'https://instagram.com/testwebsite',
  social4Href: 'https://linkedin.com/company/testwebsite',
  social5Href: 'https://github.com/testwebsite',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Mobile Apps', href: '/mobile-apps', editableId: 'link-footer-mobile-apps' },
        {
          name: 'Cloud Services',
          href: '/cloud-services',
          editableId: 'link-footer-cloud-services',
        },
        {
          name: 'Digital Marketing',
          href: '/digital-marketing',
          editableId: 'link-footer-digital-marketing',
        },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'News & Updates', href: '/news', editableId: 'link-footer-news' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Security Policy', href: '/security', editableId: 'link-footer-security' },
