...
const DEFAULT_HERO = {
  badge: 'New: Beta Testing Platform',
  title: 'Ship with confidence using',
  titleHighlight: 'intelligent testing',
  description:
    'Automated testing platform that catches bugs before your users do. Built for modern development teams who value quality and speed.',
  features: [
  ...
  statsLabel1: 'Bug Detection',
  statsValue1: '99.2% accuracy',
  statsLabel2: 'Deploy Speed',
